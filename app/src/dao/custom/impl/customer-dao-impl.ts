...
export class CustomerDAOImpl implements CustomerDAO {
    ...
    save(entity: Customer): Promise<boolean> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.connection.query(`INSERT INTO customer VALUES ('${entity.cusid}','${entity.cusname}','${entity.address}')`,
                (err, results) => {
    ...
    update(entity: Customer): Promise<boolean> {
        return new Promise((resolve, reject) => {
            ...
            this.connection.query(`UPDATE customer SET cusname = '${entity.cusname}', address ='${entity.address}' WHERE cusid='${entity.cusid
            }'`,
                (err, results) => {
